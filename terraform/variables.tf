...
variable "sas_metadata_count" { default = "1" }
variable "sas_grid_count" { default = "1" }
variable "sas_midtier_count" { default = "1" }
variable "remote_desktop_gateway_count" { default = "1" }


# instance shapes
variable "bastion_server_shape" { default = "VM.Standard2.1" }
variable "sas_metadata_server_shape" { default = "VM.Standard2.1" }
variable "sas_grid_server_shape" { default = "VM.Standard2.1" }
variable "sas_midtier_shape" { default = "VM.Standard2.1" }
variable "remote_desktop_gateway_shape" { default = "VM.Standard2.1" }
